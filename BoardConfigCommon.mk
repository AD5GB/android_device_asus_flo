...
## CMDLINE opts for ElementalX kernel base
## Default CPU clock is 1512.  Avaliable clocks:
...
BOARD_KERNEL_CMDLINE := console=ttyHSL0,115200,n8 androidboot.hardware=flo user_debug=31 msm_rtb.filter=0x3F ehci-hcd.park=3 vmalloc=340M l2_opt=2 max_oc0=1998000 max_oc1=1998000 max_oc2=1998000 max_oc3=1998000 gpu_oc=1
